...
def organizetilts( intilts, options ):
	...
	print 'len intilts is', len(intilts)	
		...
		try:
			...
			if options.stackregardless:
				...
				try:
					...
					tiltangle += orderedangles[1] - orderedangles[0]
					indexintiltseries += indexesintiltseries[1] - indexesintiltseries[0]
					collectionindex += collectionindexes[1] - collectionindexes[0]
