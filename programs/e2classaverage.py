...
def main():
	...
	if options.center == 'None' or options.center == 'none': #jesus
		options.center = None #jesus
...
class ClassAvTask(JSTask):
	...
	def __init__(self,imagefile,imagenums,usefilt=None,ref=None,niter=1,normproc=("normalize.edgemean",{}),prefilt=0,align=("rotate_translate_flip",{}),
		  aligncmp=("ccc",{}),ralign=None,raligncmp=None,averager=("mean",{}),scmp=("ccc",{}),keep=1.5,keepsig=1,automask=0,saveali=0,setsfref=0,verbose=0,n=0,center=None): #jesus
		if usefilt==None : usefilt=imagefile
		self.center=center
		
		#print "task received this center", self.center
