...
#		except: pass
		...
		cls_cmd = "e2classaverage.py --input=%s --classmx=%s/classmx_00.hdf --output=%s/classes_init.hdf --iter=8 --force --bootstrap --center=%s" %(options.input,options.path,options.path, options.center) #jesus
...
#		run("e2stacksort.py %s#allrefs_%02d %s#allrefs_%02d --byheader=class_ptcl_qual"%(options.path,it,options.path,it))
		...
		# make class-averages
		print "center for classaverage command is", options.center
